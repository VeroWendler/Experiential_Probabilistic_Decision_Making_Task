function ExpSymbNeglect_24_08_23(participant) 
...
allImagesTEST = {Circle, Cursor, Folder, Magnet, Mark, TRArrow, AI, At, Cloud, Hazel, Star};
allImageNamesTEST = {'Circle', 'Cursor', 'Folder', 'Magnet', 'Mark', 'TRArrow', 'AI', 'At', 'Cloud', 'Hazel', 'Star'};
...
filename = ['participant', num2str(participant),'_dataTEST1', num2str(randomNumber), '.mat'];
...
dataCellTEST2 = {
    ...
    rightimTEST2,
    utility_ArrayTEST2,
    chosenImageArrayTEST2
};

filename2 = ['participant', num2str(participant),'_dataTEST2', num2str(num2str(randomNumber)), '.mat'];
    ...
    for trial = 1:blockSizeSecondPartTEST
        ...
        if strcmp(selectedImageTEST2, 'left')
            ...
            if probabilityLeftTEST2 > probabilityRightTEST2
                ...
                utility_ArrayTEST2((block-1)*blockSizeSecondPartTEST + trial) = -1;
...
filenameSliderResponses = ['participant', num2str(participant), '_SliderResponsesTEST3', num2str(randomNumber), '.mat'];
...
allImagesEXP = {Fire, Equal, Circle1, Intersection, Menue, Cycle};
allImageNamesEXP = {'Fire', 'Equal', 'Circle1', 'Intersection', 'Menue', 'Cycle'};
...
current_leftchosenEXP = zeros(2 * blockSize1and2EXP + blockSize3EXP, 1);
...
dataCellEXP = {
    ...
    utility_ArrayEXP1,
    current_chosenImEXP,
    current_leftchosenEXP,
    current_unchosenImEXP,
    current_subblogEXP

};

filenameEXP = ['participant', num2str(participant),'_dataEXP1', num2str(randomNumber) '.mat'];
...
if strcmp(selectedImageEXP, 'left')
    if outcome1EXP == 1
        left_OutArrayEXP(trialNumEXP) = 1;  % Positiveleft
    else
...
% Instructions for the second training test: ES-Phase
line69 = 'EXPERIMENT: Instructions for the second test:';
line70 = '\n\n  In the second test there will be two kinds of options.';
line71 = '\n\n\n  The first kind of option is represented by the symbols you already encountered during the previous test.';
line72 = '\n\n\n  Note: The symbols maintain the same odds of winning/losing a point as in the first test.';
line73 = '\n\n\n  The second kind of options is represented by pie-charts that describe the odds of winning/losing points';
...
line81 = 'EXPERIMENT: Instructions for the second test:';
line82= '\n\n In each round, you have to choose between one of two symbols displayed on either side of the screen.';
...
filenameEXP2 = ['participant', num2str(participant),'_dataEXP2', num2str(randomNumber) '.mat'];
...
for trialEXP2 = 1:totalTrialsEXP2
       if trialEXP2 == 20                                                                                           % !!!!!!! Currently breaking here, if you want to play the whole thing delete the loop.
           break
       end     
...
% Display the final score
finalScoreMessage = sprintf('Overall you won %d points! Congrats!', scoreEXP2);
Screen('TextSize', window, 22);
DrawFormattedText(window, finalScoreMessage, 'center', 'center', black);
Screen('Flip', window);
KbStrokeWait;
...
filenameSliderResponsesEXP = ['participant', num2str(participant), '_SliderResponsesEXP', num2str(randomNumber), '.mat'];
